...
nb.cells.append(
    nbformat.v4.new_code_cell(
        ...
        "CACHE_SAMPLES_DIR = str(SETTINGS.cache_samples_dir)\n"
        ...
        'print(f"  LIVE_RETRIEVAL:     {SETTINGS.live_retrieval_enabled}")\n'
        'print(f"  EXA_API_KEY:        {\'***set***\' if SETTINGS.exa_api_key_value else \'NOT SET\'}")\n'
        'print("=" * 50)'
    )
)
...
nb.cells.append(
    nbformat.v4.new_code_cell(
        ...
        "from war_room.query_plan import format_query_plan, generate_query_plan\n"
        "\n"
...
nb.cells.append(
    nbformat.v4.new_code_cell(
        ...
        "\n"
        "# Initialize Exa client only when live retrieval is enabled.\n"
        "client = None\n"
        "if SETTINGS.live_retrieval_enabled and SETTINGS.exa_api_key_value:\n"
        "    try:\n"
        "        client = ExaClient(api_key=SETTINGS.exa_api_key_value)\n"
        "    except Exception:\n"
